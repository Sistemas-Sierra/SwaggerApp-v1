                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        var customSwagger = Assembly.ReflectionOnlyLoadFrom(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "bin", thisAssembly.GetName().Name + ".dll"));
                        c.InjectJavaScript(customSwagger, thisAssembly.GetName().Name + ".Security.jwtadd.js");
                    });
        }

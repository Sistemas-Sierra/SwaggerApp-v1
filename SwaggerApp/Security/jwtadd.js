(function () {
    $(function () {
        ...
        var AuthUI =
            ...
            '<div class="input"><a id="getToken" href="#" data-sw-translate="" style="color: blue;">Token</a></div>' +
            '<div class="input"><a id="showToken" href="#" data-sw-translate="" stype="color: blue;">?</a></div>';
    ...
    function getToken() {
        var issueUrl = "/v1/gettoken"; //REEMPLAZA AQUI
        ...
        if (username && username.trim() != "" && password && password.trim() != "") {
            $.post(issueUrl, "grant_type=password&username=" + username + "&password=" + password)
                .done(function (data) {
